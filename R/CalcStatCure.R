quantile.calc.Crude <- function(fit, q = 0.95, newdata = NULL, max.time = 20, expected = NULL,
                                rmap, ratetable = survexp.dk, last.point = 100){
...
quantile.calc.LL <- function(fit, q = 2, newdata = NULL, max.time = 20,
